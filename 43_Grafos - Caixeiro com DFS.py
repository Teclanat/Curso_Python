__author__ = 'Natanael'
"""
    Trabalhando com Grafos - Busca em Profundidade (Depth-First Search)
...
if __name__=="__main__":
    ...
    #Grafo para exemplificação do caixeiro
    grf.Adicionar_Vertice('a')
    grf.Adicionar_Vertice('b')
    grf.Adicionar_Vertice('c')
    grf.Adicionar_Vertice('d')
    grf.Adicionar_Vertice('e')
    grf.Adicionar_Vertice('f')
    ...
    while True:
        ...
        print("(M) mostra, (V) Inserir Vertice (A) Inserir Arco (B)Buscar Rota (S) Sair")
